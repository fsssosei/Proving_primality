...
from gmpy2 import mpz, ceil, sqrt, log, is_strong_prp

initial_prime_number_list = [2, 3, 5, 7, 11, 13]
strong_pseudoprime_list = [2047, 1373653, 25326001, 3215031751, 2152302898747, 3474749660383, 341550071728321, 341550071728321, 3825123056546413051, 3825123056546413051, 3825123056546413051]  #https://arxiv.org/pdf/1207.0063.pdf
